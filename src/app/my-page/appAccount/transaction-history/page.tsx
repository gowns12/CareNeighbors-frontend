'use client';
           ...
           export default function TransactionHistoryPage() {
               ...
               const handleTransactionClick = (id: string) => {
                   router.push(`/my-page/appAccount/transaction-detail/${id}`);
               };

               const handleTransferClick = () => {
                   router.push('/my-page/appAccount/transfer/select-institution');
               };
               ...
               return (
                   <Container>
                       ...
                       <AccountBox>
                           ...
                           <TransferButton onClick={handleTransferClick}>이체</TransferButton>
                       </AccountBox>
                       ...
                       <TransactionList>
                           {transactions.map((tx) => (
                               <TransactionItem key={tx.id} onClick={() => handleTransactionClick(tx.id)}>
                                   <LeftSection>
                                       <Date>{tx.date}</Date>
                                   ...
                                   <RightSection>
                                       <Amount $isPositive={tx.amount > 0}>
                                           {tx.amount > 0 ? '입금' : '출금'} {Math.abs(tx.amount).toLocaleString()}원
                                       </Amount>
